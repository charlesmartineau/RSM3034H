...
- Proxied by number of news articles, abnormal search volume (Google), or media mentions
...
- We argue that attention prior to meetings proxy for investor risk aversion.
  - Important to distinguish between news attention vs sentiment.
...
- Compare returns of no-coverage vs. high-coverage stocks (1993–2002) from NYT, WSJ, USATODAY, WP.
